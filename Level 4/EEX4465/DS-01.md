...
> [!note]
> Stacks operate on the LIFO principle – Last In, First Out. Think of a stack of plates: the last plate you put on the stack is the first one you take off.
...
> [!note]
> Queues operate on the FIFO principle – First In, First Out. This is analogous to a line of people waiting for a service; the first person in line gets served first.
